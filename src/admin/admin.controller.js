...
var AdminController = function () {
    var _classDecorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(roles_enum_1.Role.ADMIN), (0, common_1.Controller)('admin')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _getAllUsers_decorators;
    var _toggleUserActivation_decorators;
    ...
    var AdminController = _classThis = /** @class */ (function () {
        ...
        AdminController_1.prototype.toggleUserActivation = function (userId, req) {
            return __awaiter(this, void 0, void 0, function () {
                var adminId;
                return __generator(this, function (_a) {
                    adminId = req.user.userId;
                    return [2 /*return*/, this.adminService.toggleUserActivation(userId, adminId)];
                });
            });
        };
        AdminController_1.prototype.getReports = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.adminService.getReports()];
                });
            });
        };
        AdminController_1.prototype.resolveReport = function (reportId, req) {
            return __awaiter(this, void 0, void 0, function () {
                var adminId;
                return __generator(this, function (_a) {
                    adminId = req.user.userId;
                    return [2 /*return*/, this.adminService.resolveReport(reportId, adminId)];
                });
            });
        };
        AdminController_1.prototype.getStats = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.adminService.getStats()];
                });
            });
        };
    ...
    (function () {
        ...
        _toggleUserActivation_decorators = [(0, common_1.Post)('users/:id/activate')];
        _getReports_decorators = [(0, common_1.Get)('reports')];
        _resolveReport_decorators = [(0, common_1.Post)('reports/:id/resolve')];
        ...
        __esDecorate(_classThis, null, _toggleUserActivation_decorators, { kind: "method", name: "toggleUserActivation", static: false, private: false, access: { has: function (obj) { return "toggleUserActivation" in obj; }, get: function (obj) { return obj.toggleUserActivation; } }, metadata: _metadata }, null, _instanceExtraInitializers);
