...
var AdminService = function () {
    ...
    var AdminService = _classThis = /** @class */ (function () {
        ...
        AdminService_1.prototype.toggleUserActivation = function (userId, adminId) {
            return __awaiter(this, void 0, void 0, function () {
                var user, newState;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            _a.sent();
                            return [2 /*return*/, { success: true, isActive: newState }];
                    }
                });
            });
        };
        AdminService_1.prototype.getReports = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        AdminService_1.prototype.resolveReport = function (reportId, adminId) {
            return __awaiter(this, void 0, void 0, function () {
                var report;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        AdminService_1.prototype.getStats = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, totalUsers, activeUsers, totalMatches, totalMessages, totalReports, pendingReports;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a = _b.sent(), totalUsers = _a[0], activeUsers = _a[1], totalMatches = _a[2], totalMessages = _a[3], totalReports = _a[4], pendingReports = _a[5];
                            return [2 /*return*/, {
