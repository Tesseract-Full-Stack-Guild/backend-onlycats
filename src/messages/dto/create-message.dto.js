...
var CreateMessageDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateMessageDto() {
                ...
                this.receiverId = (__runInitializers(this, _matchId_extraInitializers), __runInitializers(this, _receiverId_initializers, void 0));
                this.content = (__runInitializers(this, _receiverId_extraInitializers), __runInitializers(this, _content_initializers, ''));
        ...
        (function () {
            ...
            _matchId_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsUUID)()];
            _receiverId_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsUUID)()];
            _content_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.Length)(1, 5000)];
