...
var MessagesGateway = function () {
    ...
    var MessagesGateway = _classThis = /** @class */ (function () {
        function MessagesGateway_1(messagesService) {
        ...
        MessagesGateway_1.prototype.afterInit = function () {
            this.logger.log('WebSocket gateway initialized');
        };
        MessagesGateway_1.prototype.handleConnection = function (client) {
            var userId = client.handshake.query.userId;
            if (userId) {
                this.onlineUsers.set(userId, client.id);
                this.logger.log("User ".concat(userId, " connected with socket ID: ").concat(client.id));
            }
            else {
                this.logger.warn('Client connected without userId');
            }
        };
        MessagesGateway_1.prototype.handleDisconnect = function (client) {
            for (var _i = 0, _a = this.onlineUsers.entries(); _i < _a.length; _i++) {
                var _b = _a[_i], userId = _b[0], socketId = _b[1];
                if (socketId === client.id) {
                    this.onlineUsers.delete(userId);
                    this.logger.log("User ".concat(userId, " disconnected"));
                    break;
                }
            }
        };
        MessagesGateway_1.prototype.handleSendMessage = function (dto, client) {
            return __awaiter(this, void 0, void 0, function () {
                var userId, message, receiverSocketId, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.messagesService.sendMessage(userId, dto)];
                        case 2:
                            message = _a.sent();
                            receiverSocketId = this.onlineUsers.get(message.receiverId);
                            if (receiverSocketId) {
                        ...
                        case 3:
                            error_1 = _a.sent();
                            this.logger.error("Error sending message: ".concat(error_1.message));
