...
var AuthController = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.authService.refresh(token)];
                        case 1:
                            tokens = _a.sent();
                            this.setAuthCookies(res, tokens);
                            return [2 /*return*/, { success: true, message: 'Tokens Refreshed!' }];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, { success: true, message: 'Logged out successfully!' }];
                    }
                });
            });
        };
        AuthController_1.prototype.setAuthCookies = function (res, tokens) {
            res.cookie('access_token', tokens.accessToken, {
                httpOnly: false, // Allow JS access for debugging
                secure: false,
                sameSite: 'none', // Allow cross-origin (different ports)
                maxAge: 15 * 60 * 1000,
            });
    ...
    (function () {
        ...
        _signUp_decorators = [(0, throttler_1.Throttle)({ default: { limit: 3, ttl: 60 } }), (0, common_1.HttpCode)(201), (0, common_1.Post)('register')];
        _login_decorators = [(0, throttler_1.Throttle)({ default: { limit: 3, ttl: 60 } }), (0, common_1.HttpCode)(200), (0, common_1.UseGuards)((0, passport_1.AuthGuard)('local')), (0, common_1.Post)('login')];
        _refresh_decorators = [(0, throttler_1.Throttle)({ default: { limit: 3, ttl: 60 } }), (0, common_1.HttpCode)(200), (0, common_1.Post)('refresh')];
        _logout_decorators = [(0, throttler_1.Throttle)({ default: { limit: 3, ttl: 60 } }), (0, common_1.HttpCode)(200), (0, common_1.Post)('logOut')];
