...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.findUserByUsername = function (username) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        UsersService_1.prototype.findUserByEmail = function (email) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        UsersService_1.prototype.getUser = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    user = req.user;
                    return [2 /*return*/, { success: true, message: "Welcome User: ".concat(user === null || user === void 0 ? void 0 : user.username) }];
                });
            });
        };
        UsersService_1.prototype.deactivateAccount = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UsersService_1.prototype.searchUsers = function (query, currentUserId) {
            return __awaiter(this, void 0, void 0, function () {
                var users;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                                    ...
                                    return ({
                                        ...
                                        profile: u.profile
                                            ? {
                                                name: u.profile.name,
                                                age: u.profile.age,
                                                photoUrl: ((_a = u.profile.photos[0]) === null || _a === void 0 ? void 0 : _a.url) || null,
                                            }
                                            : null,
                                    });
                                })];
