    ...
    var RequestLoggerMiddleware = _classThis = /** @class */ (function () {
        ...
        RequestLoggerMiddleware_1.prototype.use = function (req, res, next) {
            ...
            res.on('finish', function () {
                ...
                var ip = req.ip || ((_a = req.connection) === null || _a === void 0 ? void 0 : _a.remoteAddress) || 'unknown';
                var userAgent = req.headers['user-agent'] || 'unknown';
                _this.logger.log("".concat(method, " ").concat(url, " ").concat(statusCode, " ").concat(duration, "ms ").concat(ip, " ").concat(userAgent));
            });
            next();
        };
