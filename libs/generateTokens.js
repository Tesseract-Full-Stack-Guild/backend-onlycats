...
var Tokens = /** @class */ (function () {
    function Tokens(prisma, jwt) {
        this.prisma = prisma;
        this.jwt = jwt;
    }
    Tokens.prototype.generateTokens = function (user) {
    ...
    Tokens.prototype.storeTokenDB = function (userId, token) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenHash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bcrypt.hash(token, 10)];
                    case 1:
                        tokenHash = _a.sent();
